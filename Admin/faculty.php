                    ...
                    <form action="code.php" method="POST" enctype="multipart/form-data">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="faculty_designation" class="form-control checking_email" placeholder="Enter Designation" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" name="faculty_image" id="faculty_image" class="form-control" placeholder="" required>
                            </div>
                        </div>
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary"> Faculties
                        <form action="code.php" method="POST" encype="multipart/form-data">
                            <button type="submit" name="delete_multiple_data" class="btn btn-danger float-right">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="faculty_edit.php" method="post">
                                                    <input type="hidden" name="edit_faculty_id" value="<?php echo $row['id']; ?>">
                                                    <button type="submit" name="edit_faculty_btn" class="btn btn-success"> EDIT</button>
                                                </form>
                                            </td>
                                            <td>
                                                <form action="code.php" method="post">
                                                    <input type="hidden" name="delete_id" value="<?php echo $row['id']; ?>">
                                                    <button type="submit" name="delete_faculty_btn" class="btn btn-danger"> DELETE</button>
                                                </form>
                                            </td>
                                        </tr>
                                <?php
