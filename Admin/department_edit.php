...
if(isset($_POST['edit_dept_btn']))
{       
    $id = $_POST['edit_dept_id'];
    
    $query = "SELECT * FROM departmentcategory WHERE id ='$id' ";
        ...
        ?> 
            <form action="code.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group"> 
                    <label>name</label>
                    <input type="text" name="edit_dept_name" value="<?php echo $row['name'] ?>" class="form-control" placeholder="Enter faculty name">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <button type="submit"  class="btn btn-primary" name="dept_update_btn">Update</button>
            </form>
    <?php
    }
}
